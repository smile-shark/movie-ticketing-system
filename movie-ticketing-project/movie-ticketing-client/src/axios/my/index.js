...
export const myApi = {
  ...
  selectSimpleScreeningRoom(cinemaId) {
  ...
  insertSliceArrangement(sliceArrangement) {
    sliceArrangement.sliceArrangementStartTime = utils.urbanConversion(
      sliceArrangement.sliceArrangementStartTime
    );
    sliceArrangement.sliceArrangementEndTime = utils.urbanConversion(
  ...
  updateCinema(cinema) {
    return instance.put(myPath.updateCinema, cinema);
  },
  selectCountyByCountyId(countyId) {
    return instance.get(myPath.selectCountyByCountyId, {
      params: {
        countyId,
      },
    });
  },
  selectMarketByMarketId(marketId) {
    return instance.get(myPath.selectMarketByMarketId, {
      params: {
        marketId,
      },
    });
  ...
  activeUserTotal() {
    return instance.get(myPath.activeUserTotal);
  },
  userTotal() {
    return instance.get(myPath.userTotal);
  },
  cinemaTotal() {
    return instance.get(myPath.cinemaTotal);
  },
  aMonthHasSliceArrangementTotal() {
    return instance.get(myPath.aMonthHasSliceArrangementTotal);
  },
  movieTotal() {
    return instance.get(myPath.movieTotal);
  },
  orderTotalAmount() {
    return instance.get(myPath.orderTotalAmount);
  },
  payedOrderTotalAmount() {
    return instance.get(myPath.payedOrderTotalAmount);
  },
  orderTotal() {
    return instance.get(myPath.orderTotal);
  },
  payedOrderTotal() {
    return instance.get(myPath.payedOrderTotal);
  },
  applyForNewMovieTotal() {
    return instance.get(myPath.applyForNewMovieTotal);
  },
  selectOrderVoteAllPriceByTimeNotCinema(startTime, endTime) {
    return instance.get(myPath.selectOrderVoteAllPriceByTimeNotCinema, {
      params: {
        startTime: utils.urbanConversion(startTime),
        endTime: utils.urbanConversion(endTime),
      },
  ...
  selectOrderVotePriceByTimeNotCinema(startTime, endTime) {
    return instance.get(myPath.selectOrderVotePriceByTimeNotCinema, {
      params: {
        startTime: utils.urbanConversion(startTime),
        endTime: utils.urbanConversion(endTime),
      },
  ...
  selectChartValueByTimeAndMovieNotCinema(startTime, endTime) {
    return instance.get(myPath.selectChartValueByTimeAndMovieNotCinema, {
      params: {
        startTime: utils.urbanConversion(startTime),
        endTime: utils.urbanConversion(endTime),
      },
  ...
  selectChartValueByTimeGroupCinema(startTime, endTime) {
    return instance.get(myPath.selectChartValueByTimeGroupCinema, {
      params: {
        startTime: utils.urbanConversion(startTime),
        endTime: utils.urbanConversion(endTime),
      },
