<template>
  ...
  <el-dialog :visible.sync="selectCinemaDialogVisible" 
...
export default {
  ...
  mounted(){
      if(localStorage.getItem('cinemaManagementInfo')){
          this.cinemaManagementInfo=JSON.parse(localStorage.getItem('cinemaManagementInfo'))
      }
      this.defaultActive=this.$route.path
      myApi.selectCinemaByCinemaManagementId(this.cinemaManagementInfo.cinemaManagementId).then(res=>{
