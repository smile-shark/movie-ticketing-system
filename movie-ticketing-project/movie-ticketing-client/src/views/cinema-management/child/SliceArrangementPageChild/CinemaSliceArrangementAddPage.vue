        ...
        <el-form :model="sliceArrangement" label-width="100px">
          <el-col :span="6">
            <el-form-item label="选择电影">
              <el-select
                v-model="sliceArrangement.movieId"
                placeholder="请选择电影"
                filterable
                @change="cinemaSelectMovieList"
              >
                <el-option
            ...
            <el-form-item label="选择放映厅">
              <el-select
                v-model="sliceArrangement.screeningRoomId"
                placeholder="请选择放映厅"
                filterable
              >
                <el-option
            ...
            <el-form-item label="开始时间">
              <el-date-picker
                v-model="sliceArrangement.sliceArrangementStartTime"
                type="datetime"
                placeholder="选择开始时间"
            ...
            <el-form-item label="结束时间">
              <el-date-picker
                v-model="sliceArrangement.sliceArrangementEndTime"
                type="datetime"
                placeholder="选择结束时间"
              ></el-date-picker>
            </el-form-item>
          ...
          <el-col :span="6">
            <el-form-item label="票价">
              <el-input
                v-model="sliceArrangement.votePrice"
                placeholder="请输入票价"
              ></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6">
            ...
            <el-form-item> &nbsp; </el-form-item>
            <el-form-item>
              <el-button type="primary" @click="insertSliceArrangement"
                >创建排片</el-button
              >
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    cinemaSelectMovieList() {
      myApi
        .cinemaSelectMovieList({
          movieId: this.sliceArrangement.movieId,
          page: 1,
          size: 1,
        })
        .then((res) => {
    ...
    selectSimpleScreeningRoom() {
      ...
      myApi
        .selectSimpleScreeningRoom(this.cinemaId)
        .then((res) => {
          if (res.data.code == 200) {
    ...
    insertSliceArrangement() {
      ...
      try {
        this.sliceArrangement.votePrice = Number(
          this.sliceArrangement.votePrice
        );
      } catch (e) {
      ...
      if (
        this.sliceArrangement.sliceArrangementStartTime >=
        this.sliceArrangement.sliceArrangementEndTime
      ) {
        this.$message.error("结束时间必须大于开始时间");
        return;
      }
      if (
        this.sliceArrangement.sliceArrangementStartTime.getTime &&
        this.sliceArrangement.sliceArrangementStartTime.getTime() <
          new Date().getTime()
      ) {
      ...
      myApi
        .selectScreeningRoomByScreeningRoomId(
          this.sliceArrangement.screeningRoomId
        )
        .then((res) => {
          if (res.data.code == 200) {
            ...
            myApi
              .insertSliceArrangement(this.sliceArrangement)
              .then((res) => {
                if (res.data.code == 200) {
