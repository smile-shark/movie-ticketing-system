    ...
    <el-row style="height: 9vh">
      <el-col :span="24" class="title-container">
        <div style="padding: 5px; display: flex; align-items: center">
          ...
          >
            <div
              v-if="platformInfo.platformManagementName"
              style="display: flex; align-items: center"
            >
              <el-avatar
                :size="40"
                :src="platformInfo.platformManagementProfilePicture"
              ></el-avatar>
              <span
                class="login-text"
                style="
        ...
        >
          <div>
            ...
            >
              ...
              <el-submenu index="">
                <span slot="title">
                  <i class="el-icon-video-camera-solid"></i>电影管理</span
                >
                <el-menu-item index="/platform/home/list-movie"
                  >电影信息列表</el-menu-item
                >
                <el-menu-item index="/platform/home/insert-movie"
                  >新增电影</el-menu-item
                >
                <el-menu-item index="/platform/home/update-movie"
                  >电影信息校正</el-menu-item
                >
                <el-menu-item index="/platform/home/type-movie"
                  >电影类型管理</el-menu-item
                >
              </el-submenu>
              <el-submenu index="">
                ...
                >
                <el-menu-item index="/platform/home/list-user"
                  >用户列表</el-menu-item
                >
                <el-menu-item index="/platform/home/detail-user"
                  >用户详细</el-menu-item
                >
              </el-submenu>
              <el-submenu index="">
                <span slot="title"
                  ><i class="el-icon-s-cooperation"></i>影院管理</span
                >
                <el-menu-item index="/platform/home/cinema-account-management"
                  >影院账号管理</el-menu-item
                >
              </el-submenu>
              <el-submenu index="">
                <span slot="title"><i class="el-icon-s-grid"></i>其他管理</span>
                <el-menu-item index="/platform/home/mobile-display"
                  >用户轮动图管理</el-menu-item
                >
